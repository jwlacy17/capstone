...
** NFT platforms offer either or both of building NFTs using the platform's native smart contract or creating a custom contract. Some marketplaces let creators import custom contracts created elsewhere. **
        ...
        <p> If you have any questions regarding your output, please contact PwC for further explanation.
         </p>
     </body>
     ...
     <script>
        function getResult() {
           ...
           if (onemark == 0 && threemark == 0){
             ...
             console.log("no")
             blockchain = "Your Blockchain Output: FLOW is your suggested blockchain platform and your suggested marketplace is OpenSea"
           }
